...
- Git, Docker, ...
 - ***Projects M2***:
   ...
   - La classification croisée appliquée aux données textuelles usuelles [RapportCoClust.pdf](https://github.com/lucasiscovici/CV/blob/master/RapportCoClust%20(1).pdf)
...
90 jours étant un nombre de jours, ni trop court et ni trop long, pour bien s’organiser
  ...
  - **Méthodes de clustering pour des données législatives et judiciaires** (R) [presentation](https://www.slideshare.net/slideshow/embed_code/key/8TK0VwoZJ1BYs2)
